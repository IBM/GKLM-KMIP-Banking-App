...
kmip_client = ProxyKmipClient(
    ...
    cert=os.path.join(certs,'my_signed_client_cert.pem'), #'/Users/yash/Developer/gklm-kmip-app/backend/certs/my_signed_client_cert.pem',
    key=os.path.join(certs,'ca_key.pem'), #'/Users/yash/Developer/gklm-kmip-app/backend/certs/ca_key.pem',
    ca=os.path.join(certs,'ca_cert.pem'), #'/Users/yash/Developer/gklm-kmip-app/backend/certs/ca_cert.pem',
    )
    

# Create a key
def create_kmip_key(key_type='AES', key_length=256, name='acd'):
    with kmip_client:
...
if __name__ == '__main__':
    ...
    # Fetch the key
    key = fetch_kmip_key('KEY-086edb0-711b8053-b5b8-41f7-9038-0777ba23fc40')
